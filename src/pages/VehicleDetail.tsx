...
import VehicleDetailSection from '@/components/vehicle-detail/VehicleDetailSection';
import RelatedVehiclesSection from '@/components/vehicle-detail/RelatedVehiclesSection';
